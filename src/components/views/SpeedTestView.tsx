      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
            {isDutch ? 'Woordendril (Zonder Tijdslimiet)' : 'Word Drill (Untimed)'}
          </h2>
          <p className="text-xs sm:text-sm text-slate-500">
            {isDutch 
              ? 'Oefen Litouwse woorden op je eigen tempo zonder tijdsdruk of aftellende klok' 
              : 'Untimed vocabulary drill at your own comfortable learning pace'}
          </p>
        </div>

        {/* Combo Pill */}
        <div className="px-4 py-2 rounded-2xl bg-amber-50 border border-amber-200 text-amber-800 text-xs font-black flex items-center gap-1.5 shadow-2xs">
